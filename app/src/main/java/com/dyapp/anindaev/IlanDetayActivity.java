...
public class IlanDetayActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.ilandetay_menu, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.kisiIlanlari:
                Intent intent = new Intent(IlanDetayActivity.this, KisiTumIlanlariActivity.class);
    ...
    public void detaylariGetir(String ilan_id) {
        final ProgressDialog progressDialog = new ProgressDialog(IlanDetayActivity.this);
                    ...
                    x.enqueue(new Callback<FavoriIslemPojo>() {
                        ...
                        public void onResponse(Call<FavoriIslemPojo> call, Response<FavoriIslemPojo> response) {
                            if (response.body().getText().equals("Favoriden cikartildi.")) {
                                ...
                                favoriKontrol();
                                favoriMailIstek(kul_id, otherID, ilan_id);
    ...
    public void favoriMailIstek(String kul_id, String other_id, String ilan_id) {
        Call<BildirimMailPojo> x = ManagerAll.getInstance().favoriMailGonderme(kul_id, other_id, ilan_id);
        x.enqueue(new Callback<BildirimMailPojo>() {
            @Override
            public void onResponse(Call<BildirimMailPojo> call, Response<BildirimMailPojo> response) {

            }

            @Override
            public void onFailure(Call<BildirimMailPojo> call, Throwable t) {
